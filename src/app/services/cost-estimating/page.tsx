      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-16">
          ...
          <p className="text-rla-stone text-lg leading-relaxed font-light max-w-2xl">
            Precision from the ground up. Detailed horizontal development cost
            estimates built on real project data from across Southern California.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                "Wet utilities — sewer, water, storm drain",
                "Dry utilities — electrical, gas, telecom",
                "Street and infrastructure improvements",
                "Off-site improvement estimates",
                "Landscape, walls, and amenities",
                "Fee analysis by jurisdiction",
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                "Built on 100+ real Southern California projects",
                "Calibrated against actual delivered costs",
                "Escalation-adjusted for current market conditions",
                "Fee schedules maintained by jurisdiction",
                "AI-assisted modeling for speed and precision",
                "Line-item detail — not regional averages",
              ].map((item) => (
                <li key={item} className="flex items-start gap-3">
                  <span className="w-1 h-1 rounded-full bg-rla-sienna mt-2.5 shrink-0" />
                  <span className="text-rla-stone font-light">{item}</span>
        ...
        <div className="border-t border-rla-border pt-12">
          <p className="text-rla-stone text-sm mb-6">
            Need a detailed horizontal cost estimate for your project?
          </p>
          <Link
            href="/#contact"
